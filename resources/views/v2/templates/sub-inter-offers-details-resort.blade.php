...
@section('interna')
    ...
    <div class="sub-inter-special gms">
        ...
        @if($concept->estado == 'valid' && count($bloques) > 0 || count($orderRst) > 0)
            ...
            <section class="container individual-resort desc-offer">
                ...
                <div class="row pb-lg-7">
                    <p class="h1 m-auto pb-5">{{__("resorts/the-royal-cancun/offer-individual.gallery")}}</p>
                    <div class="col-12 gallery-intern-resort d-flex pb-3">
                        <div class="item item-group">
                            <img class="w-100" src="{{asset('/img/resorts/the-royal-cancun/gallery-individual-offer/1.jpg')}}" data-toggle="modal" data-target="#gallery-intern">
                            <div class="mosaic-grid d-flex">
                                <img class="w-100" src="{{asset('/img/resorts/the-royal-cancun/gallery-individual-offer/2.jpg')}}" data-toggle="modal" data-target="#gallery-intern">
                                <img class="w-100" src="{{asset('/img/resorts/the-royal-cancun/gallery-individual-offer/3.jpg')}}" data-toggle="modal" data-target="#gallery-intern">
                            </div>
                        </div>

                        <div class="item item-big">
                            <img class="w-100 h-100" src="{{asset('/img/resorts/the-royal-cancun/gallery-individual-offer/4.jpg')}}" data-toggle="modal" data-target="#gallery-intern">
                        </div>

                        <div class="item item-double">
                            <img class="w-100" src="{{asset('/img/resorts/the-royal-cancun/gallery-individual-offer/5.jpg')}}" data-toggle="modal" data-target="#gallery-intern">
                            <img class="w-100" src="{{asset('/img/resorts/the-royal-cancun/gallery-individual-offer/6.jpg')}}" data-toggle="modal" data-target="#gallery-intern">
                        </div>
                    </div>
                </div>

                @php
                    $resort = ($mexicamCaribbean[1][0]);
                    $amenities = __('resorts/'.$resort->resort->identifier_rr.'/fact-sheet.amenities');
                @endphp
                <div class="list-amenities pb-lg-7">
                    <p class="h1 m-auto pb-lg-6">{{__("resorts/the-royal-cancun/offer-individual.amenities")}}</p>
                ...
                <div class="info-call pb-lg-6 col-6 m-auto text-center">
                    <hr>
