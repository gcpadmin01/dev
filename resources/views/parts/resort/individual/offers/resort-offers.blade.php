@php
    ...
    #dd(__('specials/setup/setup.'.$resort));
    ...
    if($val!='all'){
      ...
      if($total>=1){
        $cad_tem = $pieces[0];
        if(is_numeric($cad_tem)){
            if($cad_tem>0 && $cad_tem<=$offers){
                $offers=1;
            }else{$offers=0;}
        }else{ $offers=0; }
      }
        ...
        <div class="row">
            @for($i=0;$i<$offers;$i++)
                @php
                    ...
                    if($resort=='grand-residences-riviera-cancun'){
                        $img_small="img/deals/".$slug_oferta."-".$resort.".jpg?v=".time();
                    }else{
                        $img_small="img/deals/".$slug_oferta.".jpg?v=".time();
                    }
                                        ...
                                        <div class="col-12">
                                            <!--<a class="card-title"
                                               href="{{lang_url("/".__('routes.deals').'/'.__('routes.hotels').'/'.$slug_oferta)}}">-->
                                                <span class="card-title">{{__('special-offer/'.$slug_oferta.'.title')}}</span>
                                            <!--</a>-->
                                        </div>
                                    </div>
                                </div>
