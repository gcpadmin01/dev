                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input check-input-destino" value="all"
                                   id="allDestinations" {{$evento==1?'checked':''}}>All
                        </label>
                    </div>
            ...
            @for($i=0;$i<$resorts;$i++)
                @php
                    ...
                    if($slug=='luxury-resort' || $slug=='hotel-de-lujo'){
                        $img_small="img/deals/".$slug_resort.".gif";
...
@for($a=0;$a<$resorts;$a++)
    @php
        ...
        $booking = __('special-offer/'.$slug.'.booking');
        if ($booking == 'special-offer/'.$slug.'.booking') {
            $booking = 0;
        }
    @endphp
    ...
    @if($booking == 0)
        <div class="checkAvailabityModal checkAvailabityModalRooms modal fade" 
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <form action="https://reservations.travelclick.com/bookings.jsp" method="GET"
                        ...
                        <div class="modal-body">
                            <div class="w-100 text-center">
                                <h6 class="text-uppercase" id="resortoffer">
                                    {{__('special-offer/'.$slug.'.resorts.'.$a.'.name')}} - {{$lb_rate_plan}}
                                </h6>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="booking-interno-inputs">
                                        ...
                                        <div class="input-group date"  id="modalDeals{{$a}}">
                                            <input type="text" class="form-control dateinB" name="datein" placeholder="{{$hoy}}" value="{{$hoy}}">
                                    ...
                                    <div class="booking-interno-inputs">
                                        ...
                                        <div class="input-group date"  id="modalDeals{{$a}}">
                                            <input type="text" name="dateout" class="form-control dateoutB" placeholder="{{$hoymas5}}" value="{{$hoymas5}}">
                                            <div class="input-group-addon">
                                                <span class="icono-calendario"></span>
                                            </div>
                                        </div>
                            ...
                            @if (App::getLocale() == 'es')
                                <input type="hidden" name="languageid"  value="2">@endif
                                <input type="hidden" name="subchan" value="royalreservations.com">                                                             
                                <div class="text-center modal-bottom-text to-button" style="">
                                    <button type="submit" class="my-4 text-uppercase button-modal-book bold btn-book-now" id="">
