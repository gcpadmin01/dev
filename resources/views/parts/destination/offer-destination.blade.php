@php
    ...
    $total_offers=count(__('special-offer/setup/setup.'.$destino));
    ...
    <div class="col-12 mb-5 bg-light-gray">
        <div class="row">
            ...
            @for($i=0;$i<$total_offers;$i++)
                @php
                    $slug_oferta=__('special-offer/setup/setup.'.$destino.'.'.$i.'.slug');
                    $destino_id= __('special-offer/setup/setup.'.$destino.'.'.$i.'.destination');
                ...
                @endphp
                @for($q=0;$q<$resorts;$q++)
                    @if((__('special-offer/'.$slug_oferta.'.resorts.'.$q.'.destination')==$destino_id) )
                        @php
                            $contador ++;
                            $stars = __('special-offer/'.$slug_oferta.'.resorts.'.$q.'.stars');
                            $destino_id = __('special-offer/'.$slug_oferta.'.resorts.'.$q.'.destination');
                            $slug_resort = __('special-offer/'.$slug_oferta.'.resorts.'.$q.'.slug');
                            $slug_oferta=__('special-offer/'.$slug_oferta.'.slug');
                            ...
                            //$destino = __('special-offer/'.$slug_oferta.'.resorts.'.$q.'.destination');
                            switch($destino_id){
                            ...
                            <div class="card card-resort h-100 ">
                                <div class="card-header">
                                    <img class="w-100" src="{{ asset($img_small)}}"
                                         alt="{{__('special-offer/'.$slug_oferta.'.resorts.'.$q.'.alt')}}"
                                         title="{{__('special-offer/'.$slug_oferta.'.resorts.'.$q.'.alt')}}">
                                    <a class="icon-small" href="#" data-toggle="modal"
                                       data-target="#picturemodal-{{$q}}">
                                ...
                                <div class="card-body div-title">
                                    <div class="row no-gutters">
                                        <div class="col-12">
                                            <a class="card-title"
                                               href="{{__('special-offer/'.$slug_oferta.'.resorts.'.$q.'.resort_link')}}">
                                                {!!__('special-offer/'.$slug_oferta.'.resorts.'.$q.'.name')!!}
                                            </a>
                                        </div>
                                        <div class="col-7">
                                ...
                                <div class="card-body">
                                    <div class="card-text">
                                        <a href="{{lang_url("/".__('routes.deals').'/'.__('routes.hotels').'/'.$slug_oferta)}}"
                                           class="meal-plan">{{__('special-offer/'.$slug_oferta.'.title')}}</a>
                                        <ul class="inclusion">
                                            <li>{{$lb_rate_plan}}</li>
                                ...
                                <div class="room-offer mb-3">
                                    <div class="row d-flex">
                                        ...
                                        <div class="col-6 text-center align-self-center">
                                            <a href="#" data-toggle="modal" data-target="#form-{{$contador}}"
                        ...
                        <!-- Modal pictures-->
                        <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="picturemodal-{{$i}}"
                             aria-hidden="true"
                             id="picturemodal-{{$q}}">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <p class="modal-title" >
                                            <b>{!!__('special-offer/'.$slug_oferta.'.resorts.'.$q.'.name')!!}</b>
                                        </p>
                                    ...
                                    <div class="modal-body">
                                        <img class="w-100" src="{{ asset($img_big)}}"
                                             alt="{!!__('special-offer/'.$slug_oferta.'.resorts.'.$q.'.name')!!}"
                                             title="{!!__('special-offer/'.$slug_oferta.'.resorts.'.$q.'.name')!!}">
                                    </div>
                        ...
                        <!-- Modal information-->
                        <div class="modal fade" id="masinformacionoferta-{{$i}}" tabindex="-1" role="dialog"
                        ...
                        <!-- Modal booknow-->
                        @if($booking == 0)                        
                        <div class="checkAvailabityModal checkAvailabityModalRooms modal fade" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="https://reservations.travelclick.com/bookings.jsp"
                                          method="GET"
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="tab-content">
                                                    <div class="booking-interno-inputs">
                                                        ...
                                                        <div class="input-group date" id="modalDeals{{$i}}">
                                                            <input type="text" class="form-control dateinB"
                                                                   name="datein"
                                            ...
                                            <div class="text-center modal-bottom-text to-button" style="">
                                                <button type="submit" class="my-4 text-uppercase button-modal-book bold">{{ __('general.booking.btn.book_now') }}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
        ...
        <div class="modal fade select2-modal checkAvailabityModal" 
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="w-100 text-center">
                            <h6 class="text-uppercase"id="resortoffer"> {{__('special-offer/'.$slug_oferta.'.resorts.'.$q.'.name')}}</h6>
                        </div>
