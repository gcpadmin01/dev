...
return [
    ...
    'title' => 'The Royal Caribbean Fact Sheet',
    'title_certificate' => 'Our Certifications',
    'premios' => [
        'green-leaders-silver',
        'certificate-2019-en'
    ],
    'amenities_title' => 'The Royal Caribbean Amenities',
    'amenities' => [
        0=>[
            'icon' => 'beachfront',       'title' => 'Beachfront Resort',
        ],
        1=>[
            'icon' => 'pool',       'title' => 'Outdoor Heated Pool',
        ],
        ...
        5=>[
            'icon' => 'restaurants',       'title' => '6 Restaurants',
        ],
        6=>[
        ...
        15=>[
            'icon' => 'shuttle',       'title' => 'Shuttle between sister resorts',
        ],
        16=>[
        ...
        18=>[
            'icon' => 'car-rental',       'title' => 'Car Rental desk',
        ],
    ],

    'policies_title' => 'The Royal Caribbean Policies',

    'check-in' => '3:00 p.m.',
   'check-out' => '11:00 a.m.',

    'resort_policies'=>[
        0 =>'Check-in: 3pm / Check-out: 11 a.m.',
        1 =>'Minimum Check-in age: 21 years old',
        2 =>'Kids are considered 4 to 12 years old',
        3 =>'Teens are considered 13 to 17 years old',
        4 =>'Payment  type accepted at the property: Mastercard, Visa, AMEX',
    ...
    'near_title' => 'The Royal Caribbean Near by Things to do',

    'things' => [

        0=>[
            'title' => 'Cancun Mayan Museum',
            'image' => [
                'src'   => 'the-royal-caribbean-near-by-things-to-do-a.jpg',
                'alt'   => 'Cancun Mayan Museum'
            ],
        ],
        ...
        4=>[
            ...
            'title' => 'El Rey Archaeological Zone',
            'image' => [
                'src'   => 'the-royal-caribbean-near-by-things-to-do-e.jpg',
                'alt'   => 'El Rey Archaeological Zone'
            ],
        ],

        5=>[
            'title' => 'Parque Maya Cancun',
            'image' => [
                'src'   => 'the-royal-caribbean-near-by-things-to-do-f.jpg',
                'alt'   => 'Parque Maya Cancun',
            ],
        ],
    ],

    'rate_title' => 'The Royal Caribbean Rate Plans',
    ...
    'terms_title' => 'The Royal Caribbean Terms & Conditions',
    ...
    'terms'=>[
        ...
        4 =>'A security deposit is required upon arrival for any incidental charge. This deposit will be for $500 USD, this amount is per stay, and is fully refundable upon check-out; subject to a damage inspection of accommodation.',
