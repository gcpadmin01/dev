...
return [
    ...
    'subtitle_interna_reviews' => 'Read the experiences of some guests of the resort',
    'all_reviews' => 'beach-resorts/ancora/ancora-resort-reviews',
    'reviews' => [
        [
            'date' => 'May 10th, 2019',
            'title' => 'Great stay!',
            'content' => "Always clean facility, security all over the building, gated parking lot, amazing buffet breakfast offered at the Villa, nice clean pool, I would also recommend this place to anyone who wants to visit the island.",
            'label'=>'Everyone',
            'person' => [
                'name' => 'Jason',
        ...
        [
            ...
            'title' => 'Fantastic Vacation at Villas at Simpson Bay',
            'content' => "We just returned from beautiful St. Maarten and The Villas at Simpson Bay. I can't say enough about this wonderful spot. Our room, which was a one bedroom overlooking the bay was immaculate. The staff were incredibly friendly & there to help you whenever you had a question. The food at La Patrona restaurant was amazing. We would definitely return!",
            'label'=>'Family',
            'person' => [
                'name' => 'sr2018929',
                'profile' => asset('img/user-icon.png')
        ...
        [
            ...
            'title' => 'Great stay!',
            'content' => "I have nothing bad to say! Great room great location, great food! I was there from Wednesday to Sunday and no problems. Everyone is friendly. Close to restaurants and clubs. Right next to a beach and a portion of the beach us at the hotel. Beautiful views from my balcony!",
            'label'=>'Family',
            'person' => [
                'name' => 'Nonamefits2003',
                'profile' => asset('img/user-icon.png')
