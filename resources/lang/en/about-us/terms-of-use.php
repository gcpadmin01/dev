...
return [
    'seo'=>
    [
      'title'=>'Terms and Conditions of use | Royal Reservations',
      'metadescription'=>'Here you will find the Royal Reservations Terms and Conditions, the payments, fees, refunds and chargebacks rules, as well as the specific policies for each resort.',
    ],

    'title' => 'Terms & Conditions Of Use',
    'content' => "
        <h2>Reservation Terms & Conditions</h2>
        ...
        <h2>Reservation Payment, Fees, Penalties, Refunds and Chargebacks</h2>
        <ul>
            <li>The total price of the reservation will be charged in US dollars, the final charge in your local currency will be calculated based on the exchange rate applied by your bank on the day of charge.</li>
            <li>Reservations without full payment will not be guaranteed, the Resort may cancel a reservation if guest fails to complete payment in accordance with the applicable payment policy.</li>
            <li>Please note that&nbsp;no refunds&nbsp;will apply under any circumstances for any cancellation or modification made after check-in.</li>
            <li>Early departures will be charged for the full stay.</li>
            <li>Non-arrival (No shows) charges apply after the relevant time and will be charged to the credit/debit card supplied at the time of booking.&nbsp; The Resort reserves the right to charge for the specific number of nights of accommodation per room booked if the guest does not show up to use a confirmed reservation.</li>
            <li>Please note that refunds are long processes that could take several days before the money is reflected into the cardholder account, unfortunately this does not depend on us and once a refund is issued the time that might take would be settled between banks.
                <ul>
                    <li>A refund applies when a reservation is paid in full, and/or when your reservation is eligible for a refund: </li>
                    <li>Credit card refund may take between 10 to 15 business days before the money is reflected in the card holder account, this must be the same credit card used on the beginning, otherwise refund will not be possible, should you need further assistance, please contact our customer service department.</li> 
                </ul>
            </li>
            
        </ul>

        <h2>Specific Resort Payment Policies</h2>
        <h2>The below rules are applicable for the following Resorts</h2>
        <ul>
            <li>
        ...
        <p class='text-justify'> 
            When choosing direct Credit Card payment with the above properties, the total price of your reservation will be charged at least 21 days prior to your arrival date, any reservation booked within 20 days or less prior of the arrival date will be charged immediately. For further guidance, please consult your payment policy when booking.
        </p>

        <h2>Promotions and Inclusions Terms & Conditions</h2>
        <p class='text-justify'> 
        ...
        <ul>
            <li>The reservation is made through Royal Reservations direct channels (Call Center or Official Website), </li>
            <li>Such inclusion is included in your reservation and backed up in your confirmation letter</li>
            <li>Such inclusion is part of the existing array of inclusions and is available in our system at the time of staying </li>
            <li>Such inclusion is available and applicable at your Resort </li>
        </ul>
        ...
        <h2>Cancellations Terms & Conditions</h2>
        ...
        <h2>Forced cancellation policy</h2>
        <p class='text-justify'> 
        ...
        <ul>
            <li>If a reservations fails to complete full payment in accordance to the applicable payment policy (if you have problems to complete payment, please contact our customer service department for options)</li>
            <li>If a reservation confirmation letter is suspected of being altered whether via electronic or printed media</li>
            <li>If a confirmed and fully paid reservation receives a chargeback claim</li>
            <li>If a reservation is suspected of being made with a fraudulent credit card</li>
            <li>If the primary guest does not show up and/or if the credit card used to make the reservation is not carried up front and/or the reservation was made with a third party/corporate credit card(should this be the case, please contact our customer service department for options)</li>
        </ul>
        ...
        <h2>Room Hold Terms & Conditions</h2>
        <p class='text-justify'> 
